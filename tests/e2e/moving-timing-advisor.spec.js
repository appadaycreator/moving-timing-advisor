...
const SVC_URL = "https://appadaycreator.com/moving-timing-advisor/";
const SVC_NAME = "引っ越し時期・費用診断";

test.describe("引っ越し時期・費用診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("moving-timing-advisor");
